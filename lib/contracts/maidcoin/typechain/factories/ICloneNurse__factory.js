...
exports.ICloneNurse__factory = void 0;
const ethers_1 = require("ethers");
class ICloneNurse__factory {
    static connect(address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    }
}
exports.ICloneNurse__factory = ICloneNurse__factory;
const _abi = [
    {
        anonymous: false,
        inputs: [
...
//# sourceMappingURL=ICloneNurse__factory.js.map