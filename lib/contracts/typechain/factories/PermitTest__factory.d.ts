...
export declare class PermitTest__factory extends ContractFactory {
    ...
    deploy(_maidCoin: string, _maids: string, _nursePart: string, overrides?: Overrides): Promise<PermitTest>;
    getDeployTransaction(_maidCoin: string, _maids: string, _nursePart: string, overrides?: Overrides): TransactionRequest;
