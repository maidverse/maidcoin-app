...
export declare class MaidCafe__factory extends ContractFactory {
    ...
    deploy(_maidCoin: string, _WETH: string, overrides?: Overrides): Promise<MaidCafe>;
    getDeployTransaction(_maidCoin: string, _WETH: string, overrides?: Overrides): TransactionRequest;
