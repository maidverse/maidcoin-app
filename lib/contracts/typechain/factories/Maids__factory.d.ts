...
export declare class Maids__factory extends ContractFactory {
    ...
    deploy(_lpToken: string, _sushi: string, _royaltyReceiver: string, overrides?: Overrides): Promise<Maids>;
    getDeployTransaction(_lpToken: string, _sushi: string, _royaltyReceiver: string, overrides?: Overrides): TransactionRequest;
