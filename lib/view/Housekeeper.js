...
class Housekeeper {
    ...
    async load(type) {
        ...
        this.categoryList.empty().append(skynode_1.el(`a${type === "lingeriegirls" ? ".on" : ""}.category`, "Lingerie Girls", { click: () => ViewUtil_1.default.go("/housekeeper/lingeriegirls") }), skynode_1.el(`a${type === "sushigirls" ? ".on" : ""}.category`, "Sushi Girls", { click: () => ViewUtil_1.default.go("/housekeeper/sushigirls") }));
