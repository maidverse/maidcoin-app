...
class Farm {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = skynode_1.el(".farm-view", skynode_1.el("header", skynode_1.el("h2", "Farm"), skynode_1.el("p", "Earn $MAID!")), new MaidCorp_1.default(), new NurseFarm_1.default()));
    }
