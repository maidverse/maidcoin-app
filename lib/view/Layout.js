...
class Layout {
    constructor() {
        ...
        }), skynode_1.el("h1", skynode_1.el("a", skynode_1.el("img.pc-logo", { src: "/images/view/layout/pc-logo.png", height: "24" }), skynode_1.el("img.mobile-logo", { src: "/images/view/layout/mobile-logo.png", height: "28" }), { click: () => skyrouter_1.SkyRouter.go("/") })), new PCMenu_1.default(), skynode_1.el(".span"), new UserInfo_1.default(), skynode_1.el("a.more-button", skynode_1.el("img", { src: "/images/view/layout/more-button.png", height: "24" }), {
            click: (event, button) => {
                const rect = button.rect;
