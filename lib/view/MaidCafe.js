...
class MaidCafe {
    ...
    async loadAPR() {
        ...
        this.price.empty().appendText(CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(maidcoin.mul(ethers_1.BigNumber.from("1000000000000000000")).div(omu)), 5));
    }
    async loadBalances() {
