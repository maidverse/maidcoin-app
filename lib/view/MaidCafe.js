...
class MaidCafe {
    constructor() {
        ...
        })), skynode_1.el(".info", skynode_1.el(".apr", "Last 24 Hours APR: ", this.apr = skynode_1.el("span")), skynode_1.el(".price", "1 $OMU = ", this.price = skynode_1.el("span"), " $MAID")), this.currentTab = new StakeTab_1.default()), skynode_1.el("footer", skynode_1.el("img.npc", { src: "/images/view/maid-cafe/npc.png", height: "761" }), skynode_1.el(".balance-container", this.omuBalance = skynode_1.el(".balance"), this.maidcoinBalance = skynode_1.el(".balance")))));
        this.loadAPR();
        this.loadBalances();
    ...
    async loadAPR() {
        ...
        const apr = await Calculator_1.default.cafeAPR24();
        this.apr.empty().appendText(`${CommonUtil_1.default.numberWithCommas(apr.toString())}%`);
        this.price.empty().appendText(CommonUtil_1.default.displayPrice(maidcoin.mul(ethers_1.BigNumber.from("1000000000000000000")).div(omu)));
    }
    async loadBalances() {
        ...
        if (owner !== undefined) {
            ...
            this.omuBalance.empty().append(skynode_1.el("img", { src: "/images/view/maid-cafe/omu.png", height: "40" }), skynode_1.el(".amount", CommonUtil_1.default.numberWithCommas(CommonUtil_1.default.displayPrice(lpBalance)), skynode_1.el("span", "$OMU")));
            this.maidcoinBalance.empty().append(skynode_1.el("img", { src: "/images/view/maid-cafe/maidcoin.png", height: "41.5" }), skynode_1.el(".amount", CommonUtil_1.default.numberWithCommas(CommonUtil_1.default.displayPrice(maidBalance)), skynode_1.el("span", "$MAID")));
        }
    }
