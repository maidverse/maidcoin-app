...
class MaidCafe {
    ...
    async loadBalances() {
        ...
        if (owner !== undefined) {
            const omuBalance = await MaidCafeContract_1.default.balanceOf(owner);
            const maidBalance = await MaidCoinContract_1.default.balanceOf(owner);
            this.omuBalance.empty().append(skynode_1.el("img", { src: "/images/view/maid-cafe/omu.png", height: "40" }), skynode_1.el(".amount", CommonUtil_1.default.displayPrice(omuBalance), skynode_1.el("span", "$OMU")));
            this.maidcoinBalance.empty().append(skynode_1.el("img", { src: "/images/view/maid-cafe/maidcoin.png", height: "41.5" }), skynode_1.el(".amount", CommonUtil_1.default.displayPrice(maidBalance), skynode_1.el("span", "$MAID")));
        }
    }
