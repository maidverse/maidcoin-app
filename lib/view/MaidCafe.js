...
class MaidCafe {
    constructor() {
        ...
        })), skynode_1.el(".info", skynode_1.el(".apr", "APR: ", this.apr = skynode_1.el("span")), skynode_1.el(".price", "1 $OMU = ", this.price = skynode_1.el("span"), " $MAID")), this.currentTab = new StakeTab_1.default()), skynode_1.el("footer", skynode_1.el("img.npc", { src: "/images/view/maid-cafe/npc.png", height: "447" }), skynode_1.el(".balance-container", this.omuBalance = skynode_1.el(".balance"), this.maidcoinBalance = skynode_1.el(".balance")))));
        this.loadBalances();
