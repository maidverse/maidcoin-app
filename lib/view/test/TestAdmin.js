...
class Admin {
    constructor() {
        ...
        }))), skynode_1.el(".admin-form.nurse-type-form", skynode_1.el("h3", "Nurse Type"), skynode_1.el("label", "Part Count", partCountInput = skynode_1.el("input", { placeholder: "Part Count" })), skynode_1.el("label", "Destroy Return", destroyReturnInput = skynode_1.el("input", { placeholder: "Destroy Return" })), skynode_1.el("label", "Power", powerInput = skynode_1.el("input", { placeholder: "Power" })), skynode_1.el(".action-button-container", skynode_1.el("a.action-button.create-nurse-type-button", "Create Nurse Type", {
            click: async () => {
                await CloneNursesContract_1.default.addNurseType(parseInt(partCountInput.domElement.value, 10), ethers_1.utils.parseEther(destroyReturnInput.domElement.value), parseInt(powerInput.domElement.value, 10));
            },
