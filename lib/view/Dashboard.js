...
class Dashboard {
    ...
    async load() {
        ...
        this.welcomeContainer.empty().append(skynode_1.el(".welcome", skynode_1.el("img", { src: "/images/view/dashboard/welcome.png", height: "142.5" }), skynode_1.el(".info", skynode_1.el("p", "Welcome to MaidCoin"), skynode_1.el("a.document-button", "Read Documnet", { href: "https://medium.com/maid-coin", target: "_blank" }), connected === true ? undefined : skynode_1.el("a.connect-wallet-button", "Connect Wallet", {
