...
class Dashboard {
    ...
    async load() {
        ...
        if (this.welcomeContainer.deleted !== true && this.store.get("close-welcome") !== true) {
            ...
            }), skynode_1.el(".info", skynode_1.el("p", "Welcome to MaidCoin"), skynode_1.el("a.document-button", "Read Document", { href: "https://shillbo.medium.com/how-to-farm-maidcoin-play-the-game-2ee832a8e91c", target: "_blank" }), connected === true ? undefined : skynode_1.el("a.connect-wallet-button", "Connect Wallet", {
