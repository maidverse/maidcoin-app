...
class ChargeNursePopup extends skynode_1.Popup {
    ...
    refreshLifetime() {
        if (this.nurseType !== undefined && this.input !== undefined) {
            this.lifetime?.empty().appendText(CommonUtil_1.default.displayBlockDuration(Calculator_1.default.nurseLifetime(this.nurseType, parseInt(this.input.domElement.value, 10), false)));
        }
    }
    async load() {
