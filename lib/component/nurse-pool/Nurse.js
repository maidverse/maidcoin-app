...
class Nurse extends skynode_1.DomNode {
    ...
    async load() {
        ...
        this.append(skynode_1.el("a.claim-button", skynode_1.el("img.coin-image", { src: "/images/component/nurse-pool/maidcoin.png", height: "29" }), this.pendingReward = skynode_1.el(".amount", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(pendingReward))), {
            click: async (event) => {
