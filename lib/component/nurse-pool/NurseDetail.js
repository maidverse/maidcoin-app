...
class NurseDetail extends skynode_1.Popup {
    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            })), skynode_1.el("a.tweet-button", "Share", { href: `https://twitter.com/intent/tweet?text=${encodeURIComponent(`MaidCoin CloneNurse - ${nurseType.name}\nhttps://app.maidcoin.org/clonenurses/${this.nurseId}`)}`, target: "_blank" }));
        }
        this.refreshLifetime();
    }
    delete() {
