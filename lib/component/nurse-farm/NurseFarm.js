    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            if (supportingAmount.eq(0) === true) {
                this.addClass("empty");
                this.content.empty().append(skynode_1.el(".name", "Clone Nurse"), skynode_1.el(".total-lp-amount", "Total Deposited LP: ", skynode_1.el("span", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalLPAmount)))), skynode_1.el("a.add-button", skynode_1.el("img", { src: "/images/component/nurse-farm/add-button.png", height: "132.5" }), {
                    click: () => new Alert_1.default("Support Nurse", "Supporting Nurse feature is coming soon.", "Confirm"),
                }));
                const apr = await Calculator_1.default.apr(3);
                this.footer.empty().append(skynode_1.el(".property.apr", "APR: ", skynode_1.el("span", `${CommonUtil_1.default.numberWithCommas(String(apr))}%`)));
            }
            else {
                ...
                }), skynode_1.el(".total-lp-amount", "Total Deposited LP: ", skynode_1.el("span", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalLPAmount)))), skynode_1.el("a.claim-button", skynode_1.el("img.maidcoin", { src: "/images/component/maid-corp/maidcoin.png", height: "29" }), skynode_1.el("span.reward", ethers_1.utils.formatEther(reward))), skynode_1.el("a.desupport-button", "Desupport", {
                    click: async () => {
                ...
                const apr = await Calculator_1.default.apr(3);
                this.footer.empty().append(skynode_1.el(".property.lp-amount", "LP Supported By Me: ", skynode_1.el("span", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(lpAmount)))), skynode_1.el(".property.apr", "APR: ", skynode_1.el("span", `${CommonUtil_1.default.numberWithCommas(String(apr))}%`)));
            }
        }
    }
    delete() {
