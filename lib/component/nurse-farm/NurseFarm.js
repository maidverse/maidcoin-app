...
class NurseFarm extends skynode_1.DomNode {
    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            const totalLPAmount = await TheMasterContract_1.default.getPoolAmount(3);
            if (supportingAmount.eq(0) === true) {
                ...
                const apr = await Calculator_1.default.poolAPR(3);
                this.footer.empty().append(skynode_1.el(".property.lp-amount", "LP Supported By Me: ", skynode_1.el("span", CommonUtil_1.default.displayPrice(lpAmount))), skynode_1.el(".property.apr", "APR: ", skynode_1.el("span", `${CommonUtil_1.default.numberWithCommas(apr.toString())}%`)));
            }
        }
        else {
            this.addClass("empty");
