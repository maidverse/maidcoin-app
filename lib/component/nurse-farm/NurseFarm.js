    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            if (supportingAmount.eq(0) === true) {
                ...
                this.footer.empty().append(skynode_1.el(".property.apr", "APR: ", skynode_1.el("span", `${CommonUtil_1.default.numberWithCommas(apr.toString())}%`)));
            }
            else {
                ...
                }), skynode_1.el(".total-lp-amount", "Total Deposited LP: ", skynode_1.el("span", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalLPAmount)))), skynode_1.el("a.claim-button", skynode_1.el("img.maidcoin", { src: "/images/component/maid-corp/maidcoin.png", height: "29" }), skynode_1.el("span.reward", ethers_1.utils.formatEther(reward)), {
                    click: async (event) => {
                        event.stopPropagation();
                        await TheMasterContract_1.default.deposit(3, 0);
                    },
                ...
                const apr = await Calculator_1.default.poolAPR(3);
                this.footer.empty().append(skynode_1.el(".property.lp-amount", "LP Supported By Me: ", skynode_1.el("span", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(lpAmount)))), skynode_1.el(".property.apr", "APR: ", skynode_1.el("span", `${CommonUtil_1.default.numberWithCommas(apr.toString())}%`)));
            }
        }
    }
    delete() {
