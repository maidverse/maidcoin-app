    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            if (supportingAmount.eq(0) === true) {
                ...
                const apr = await Calculator_1.default.apr(3);
                this.footer.empty().append(skynode_1.el(".property.lp-amount", "LP Supported By Me: ", skynode_1.el("span", ethers_1.utils.formatEther(lpAmount))), skynode_1.el(".property.apr", "APR: ", skynode_1.el("span", `${CommonUtil_1.default.numberWithCommas(String(apr))}%`)));
            }
        }
    }
    delete() {
