    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            if (supportingAmount.eq(0) === true) {
                ...
                }), skynode_1.el("a.claim-button", skynode_1.el("img.maidcoin", { src: "/images/component/maid-corp/maidcoin.png", height: "29" }), skynode_1.el("span.reward", ethers_1.utils.formatEther(reward))), skynode_1.el("a.desupport-button", "Desupport", {
                    click: async () => {
