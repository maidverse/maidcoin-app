...
class SelectMaidPopup extends skynode_1.Popup {
    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            this.footer.empty().append(skynode_1.el("a.start-button", ethers_1.utils.formatEther(raid.entranceFee), skynode_1.el("img.icon", { src: "/images/maidcoin.png", height: "20.5" }), "Start", {
                click: async () => {
                    let maidsAddress;
