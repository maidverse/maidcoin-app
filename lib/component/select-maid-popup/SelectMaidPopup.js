...
class SelectMaidPopup extends skynode_1.Popup {
    ...
    async load() {
        ...
        if (owner !== undefined) {
            this.footer.empty().append(skynode_1.el("a.start-button", ethers_1.utils.formatEther(this.raid.entranceFee), skynode_1.el("img.icon", { src: "/images/maidcoin.png", height: "21" }), "Start", {
                click: async () => {
                    await NurseRaidContract_1.default.enter(this.raidId, Config_1.default.contracts.Maids);
                    this.delete();
                },
            }));
        }
