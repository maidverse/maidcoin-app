...
class FirstEarnPopup extends skynode_1.Popup {
    constructor(amount) {
        ...
        this.append(this.content = skynode_1.el(".first-earn-popup", skynode_1.el("h1", "First Earn $MAID !"), skynode_1.el(".amount", skynode_1.el("span", `+ ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(amount), 5)}`), skynode_1.el("img.maidcoin", { src: "/images/component/first-earn-popup/maidcoin.png", height: "32" })), skynode_1.el("a.close-button", skynode_1.el("img", { src: "/images/component/first-earn-popup/close-button.png", height: "20" }), {
            click: () => this.delete(),
