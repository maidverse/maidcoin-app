...
class CreateNursePopup extends skynode_1.Popup {
    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            this.content.append(skynode_1.el("img.part", { src: `https://storage.googleapis.com/maidcoin/NursePart/${tokenInfo.name}.png`, height: "60" }), skynode_1.el(".part-count", this.input = skynode_1.el("input", {
            ...
            }), ` / ${this.nurseTypeInfo.partCount}`), this.range = skynode_1.el("input.range", {
                type: "range",
            ...
            }), this.lifetime = skynode_1.el(".lifetime"));
            this.refreshLifetime();
        }
    }
}
