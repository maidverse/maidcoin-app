...
class CreateNursePopup extends skynode_1.Popup {
    ...
    refreshLifetime() {
        if (this.nurseTypeInfo !== undefined && this.input !== undefined) {
            this.lifetime?.empty().appendText(CommonUtil_1.default.displayBlockDuration(Calculator_1.default.nurseLifetime(this.nurseTypeInfo.lifetime, this.nurseTypeInfo.partCount, parseInt(this.input.domElement.value, 10), true)));
        }
    }
    async load() {
