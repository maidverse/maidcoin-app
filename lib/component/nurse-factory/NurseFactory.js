...
class NurseFactory extends skynode_1.DomNode {
    ...
    async load() {
        ...
        this.content.empty().append(skynode_1.el(".image", {
            style: {
        ...
        this.footer.empty().append(skynode_1.el(".name", tokenInfo.name), balance === undefined ? undefined : skynode_1.el("a.create-button", "Create", {
            click: () => {
