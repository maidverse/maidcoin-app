...
class NurseFactory extends skynode_1.DomNode {
    ...
    async load() {
        ...
        }), skynode_1.el("img.part", { src: `https://storage.googleapis.com/maidcoin/NursePart/${nurseType.name}.png`, height: "60" }), balance === undefined ? undefined : skynode_1.el(".part-count", skynode_1.el("span.balance", balance.toString()), ` / ${nurseType.partCount}`), skynode_1.el(".power", skynode_1.el("img", { src: "/images/component/nurse-factory/power-icon.png", height: "13.5" }), skynode_1.el("span", String(nurseType.power))));
