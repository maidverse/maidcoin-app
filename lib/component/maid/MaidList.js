...
class MaidList extends skynode_1.DomNode {
    ...
    async loadMaids() {
        skyutil_1.default.repeat(Config_1.default.maidCount, async (maidId) => {
            new MaidBook_1.default(Config_1.default.maidCount - maidId - 1).appendTo(this.maidContainer);
        });
    }
}
