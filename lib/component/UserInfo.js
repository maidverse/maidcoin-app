...
class UserInfo extends skynode_1.DomNode {
    ...
    async loadBalances() {
        ...
        if (owner !== undefined) {
            ...
            this.maidCoinPanel.empty().append(skynode_1.el(".balance", skynode_1.el("img.icon", { src: "/images/lptoken.png", height: "20.5" }), skynode_1.el(".amount", ethers_1.utils.formatEther(lpBalance))), skynode_1.el(".balance", skynode_1.el("img.icon", { src: "/images/maidcoin.png", height: "20.5" }), skynode_1.el(".amount", ethers_1.utils.formatEther(maidBalance))));
        }
    }
    delete() {
