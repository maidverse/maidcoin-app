...
class UserInfo extends skynode_1.DomNode {
    ...
    async loadBalances() {
        ...
        if (owner !== undefined) {
            ...
            this.maidCoinPanel.empty().append(skynode_1.el(".balance", skynode_1.el("img.icon", { src: "/images/lptoken.png", height: "20.5" }), skynode_1.el(".amount", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(lpBalance))), skynode_1.el("a.add-button", skynode_1.el("img", { src: "/images/component/user-info/add-button.png", height: "19" }), { click: () => ViewUtil_1.default.go("/test/test-lp-token") })), skynode_1.el(".balance", skynode_1.el("img.icon", { src: "/images/maidcoin.png", height: "20.5" }), skynode_1.el(".amount", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(maidBalance))), skynode_1.el("a.add-button", skynode_1.el("img", { src: "/images/component/user-info/add-button.png", height: "19" }), { click: () => ViewUtil_1.default.go("/test/test-maidcoin") })));
        }
    }
    delete() {
