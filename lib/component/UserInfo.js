...
const EarnPopup_1 = __importDefault(require("./earn-popup/EarnPopup"));
...
class UserInfo extends skynode_1.DomNode {
    constructor() {
        ...
        this.transferHandler = async (from, to, amount) => {
            ...
            if (from === TheMasterContract_1.default.address && to === address) {
                new FirstEarnPopup_1.default(amount);
            }
            if (from === CloneNursesContract_1.default.address && to === address) {
                new EarnPopup_1.default(amount, ethers_1.BigNumber.from(0));
            }
        };
