...
class MaidCorp extends skynode_1.DomNode {
    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            this.footer.empty().append(skynode_1.el(".property.lp-amount", "LP Deposited By Me: ", skynode_1.el("span", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(lpAmount)))), skynode_1.el(".property.apr", "APR: ", skynode_1.el("span", `${CommonUtil_1.default.numberWithCommas(String(apr))}%`)));
        }
    }
    delete() {
