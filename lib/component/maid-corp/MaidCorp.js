...
class MaidCorp extends skynode_1.DomNode {
    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            const totalLPAmount = await TheMasterContract_1.default.getPoolLPAmount(1);
            ...
            this.content.empty().append(skynode_1.el(".total-lp-amount", "Total Deposited LP: ", skynode_1.el("span", CommonUtil_1.default.displayPrice(totalLPAmount))), skynode_1.el("a.claim-button", skynode_1.el("img.maidcoin", { src: "/images/component/maid-corp/maidcoin.png", height: "29" }), skynode_1.el("span.reward", CommonUtil_1.default.displayPrice(reward)), skynode_1.el("a.claim-button", "Claim"), {
                click: async (event) => {
            ...
            const apr = await Calculator_1.default.poolAPR(1);
            this.footer.empty().append(skynode_1.el(".property.lp-amount", "LP Deposited By Me: ", skynode_1.el("span", CommonUtil_1.default.displayPrice(lpAmount))), skynode_1.el(".property.apr", "APR: ", skynode_1.el("span", `${CommonUtil_1.default.numberWithCommas(apr.toString())}%`)));
        }
        else {
            const totalLPAmount = await TheMasterContract_1.default.getPoolLPAmount(1);
            this.content.empty().append(skynode_1.el(".total-lp-amount", "Total Deposited LP: ", skynode_1.el("span", CommonUtil_1.default.displayPrice(totalLPAmount))), skynode_1.el("a.withdraw-button", "Withdraw", {
