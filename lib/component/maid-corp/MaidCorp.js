...
class MaidCorp extends skynode_1.DomNode {
    ...
    async load() {
        ...
        if (owner !== undefined) {
            ...
            this.content.empty().append(skynode_1.el(".total-lp-amount", "Total Deposited LP: ", skynode_1.el("span", CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(totalLPAmount)))), skynode_1.el("a.claim-button", skynode_1.el("img.maidcoin", { src: "/images/component/maid-corp/maidcoin.png", height: "29" }), skynode_1.el("span.reward", ethers_1.utils.formatEther(reward)), {
                click: async (event) => {
