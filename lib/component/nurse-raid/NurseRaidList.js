...
class NurseRaidList extends skynode_1.DomNode {
    constructor() {
        ...
        this.append(this.loading = new Loading_1.default(), this.raidContainer = skynode_1.el(".raid-container"), skynode_1.el(".test", { style: { backgroundImage: "url(/images/component/nurse-raid/background.png", height: 155, backgroundSize: "auto 100%" } }, skynode_1.el("img", { src: "/images/test/NoelAttack.png", height: "87.5" })));
        this.loadRaids();
    }
    async loadRaids() {
