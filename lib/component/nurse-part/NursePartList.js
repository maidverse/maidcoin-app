...
class NursePartList extends skynode_1.DomNode {
    constructor() {
        ...
        this.append(skynode_1.el(".background"), this.content = skynode_1.el(".content", this.plusButton = skynode_1.el("a.zoom-button", skynode_1.el("img", { src: "/images/view/dashboard/plus-button.png", height: "23.5" }), "Go to Nurse Raids", { click: () => ViewUtil_1.default.go("/nurseraid") })));
