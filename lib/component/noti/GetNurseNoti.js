...
class GetNurseNoti extends skynode_1.DomNode {
    constructor(_nurseType) {
        ...
        this.append(skynode_1.el(".close-button", skynode_1.el("img", { src: "/images/component/noti/close-button.png" }, {
            click: () => this.delete(),
        })), skynode_1.el("h4", "Assemble Completed"), skynode_1.el("p", "You've got"), skynode_1.el("img.nurse", { src: `https://storage.googleapis.com/maidcoin/Nurse/Illust/${nurseType.name}.png`, height: "60" }));
