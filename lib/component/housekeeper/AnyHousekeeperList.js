...
class AnyHousekeeperList extends skynode_1.DomNode {
    constructor(selectable = false) {
        ...
        this.append(skynode_1.el(".background"), this.content = skynode_1.el(".content", this.zoomButton = skynode_1.el("a.zoom-button", skynode_1.el("img", { src: "/images/view/dashboard/zoom-button.png", height: "27.5" }), "View Housekeepers", { click: () => ViewUtil_1.default.go("/housekeeper") })));
