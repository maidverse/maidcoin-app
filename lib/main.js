...
const TestMaidCoin_1 = __importDefault(require("./view/test/TestMaidCoin"));
skyrouter_1.SkyRouter.route("**", Layout_1.default);
skyrouter_1.SkyRouter.route("dashboard", Dashboard_1.default);
skyrouter_1.SkyRouter.route(["", "maid"], Maid_1.default);
skyrouter_1.SkyRouter.route(["housekeeper", "housekeeper/{type}"], Housekeeper_1.default);
...
skyrouter_1.SkyRouter.route("test/test-lp-token", TestLPToken_1.default);
skyrouter_1.SkyRouter.route("test/test-maidcoin", TestMaidCoin_1.default);
