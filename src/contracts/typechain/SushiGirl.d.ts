...
interface SushiGirlInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialDepositToSushiMasterChef()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "initialDepositToSushiMasterChef",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class SushiGirl extends Contract {
  ...
  functions: {
    ...
    initialDepositToSushiMasterChef(
      overrides?: Overrides
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    initialDepositToSushiMasterChef(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    initialDepositToSushiMasterChef(overrides?: Overrides): Promise<BigNumber>;
