...
interface LingerieGirlsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "changeLPTokenToLingerieGirlPower(uint256)": FunctionFragment;
    ...
    "lpTokenToLingerieGirlPower()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "changeLPTokenToLingerieGirlPower",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "lpTokenToLingerieGirlPower",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ChangeLPTokenToLingerieGirlPower(uint256)": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "ChangeLPTokenToLingerieGirlPower"
  ): EventFragment;
...
export class LingerieGirls extends Contract {
  ...
  interface: LingerieGirlsInterface;
  ...
  functions: {
    ...
    "changeLPTokenToLingerieGirlPower(uint256)"(
      value: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
    ...
    lpTokenToLingerieGirlPower(overrides?: CallOverrides): Promise<[BigNumber]>;

    "lpTokenToLingerieGirlPower()"(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    ChangeLPTokenToLingerieGirlPower(value: null): EventFilter;
