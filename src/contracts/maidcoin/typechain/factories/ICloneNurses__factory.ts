...
export class ICloneNurses__factory {
  static readonly abi = _abi;
  static createInterface(): ICloneNursesInterface {
    return new utils.Interface(_abi) as ICloneNursesInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICloneNurses {
    return new Contract(address, _abi, signerOrProvider) as ICloneNurses;
  }
}
